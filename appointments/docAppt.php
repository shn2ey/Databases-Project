  ...
  <header>
   ...
   require('')
    if(is_array($fetchData)){
      ...
      cancelAppt($_POST['appt_date_time'])
    }
   ?> 
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="checkin.html">Manage Appointments</a>
            </li>
            <li class="nav-item ">
      ...
      <div class="sidebar-block">
              ...
              <div class="blog-item">
                ...
                <form action="docAppt.php" method="post">
                  <input type="submit" value="Cancel" name="btnAction" class="btn btn-primary wow zoomIn" />
                  <input type="hidden" value="<?php echo $data['appt_date_time'] ?>" />      
                </form>
              </div>
              <div class="blog-item">
